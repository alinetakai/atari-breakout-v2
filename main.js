// versão com aumento de complexidade (a bola ganha velocidade cada vez que atinge um dos tijolos)
  ...
  if (gameState === "play") {
    ...
    for (let i = bricks.length - 1; i >= 0; i--) {
      ...
      if (ball.x + ball.r > b.x && ball.x - ball.r < b.x + b.w &&
        ...
        ball.vy *= -1;
        ball.vx *= 1.05; // aumenta velocidade horizontal
        ball.vy *= 1.05; // aumenta velocidade vertical
